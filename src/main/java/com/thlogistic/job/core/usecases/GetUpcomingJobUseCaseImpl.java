...
public class GetUpcomingJobUseCaseImpl implements GetUpcomingJobUseCase {
    ...
    public List<GetJobResponse> execute(BaseTokenRequest<String> baseTokenRequest) {
        ...
        List<DriverJobEntity> driverJobEntities = driverJobRepository.findUpcomingJobByDriverIdAndJobStatus(driverId, JobStatus.ASSIGNED.statusCode);
