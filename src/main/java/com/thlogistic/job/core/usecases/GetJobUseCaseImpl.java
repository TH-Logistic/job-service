...
public class GetJobUseCaseImpl implements GetJobUseCase {
    ...
    private void buildJobResponse(
        ...
        builder.mustDeliverAt(DateTimeHelper.getFormattedTimeFromEpoch(jobEntity.getMustDeliverAt()));
        builder.createdAt(DateTimeHelper.getFormattedTimeFromEpoch(jobEntity.getCreatedAt()));
        builder.assignedAt(DateTimeHelper.getFormattedTimeFromEpoch(jobEntity.getAssignedAt()));
        builder.acceptedAt(DateTimeHelper.getFormattedTimeFromEpoch(jobEntity.getStartedAt()));
        builder.pickUpArriveAt(DateTimeHelper.getFormattedTimeFromEpoch(jobEntity.getPickUpArriveAt()));
        builder.pickUpDoneAt(DateTimeHelper.getFormattedTimeFromEpoch(jobEntity.getPickUpDoneAt()));
        builder.unloadArriveAt(DateTimeHelper.getFormattedTimeFromEpoch(jobEntity.getDeliveryArriveAt()));
        builder.unloadDoneAt(DateTimeHelper.getFormattedTimeFromEpoch(jobEntity.getDischargedAt()));
        builder.completedAt(DateTimeHelper.getFormattedTimeFromEpoch(jobEntity.getCompletedAt()));
